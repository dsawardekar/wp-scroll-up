	      ...
	      React.DOM.div(null, 
	        ...
	        React.DOM.div({id: "wp-spoiler-alert"}, 
	          ...
	          OptionsForm({
	            ...
	            styleTypes: this.props.styleTypes, 
	  ...
	  renderSelectOptions: function(values) {
	    return values.map(function(value, index) {
	      return (
	        React.DOM.option({
	          key: index, 
	          value: value}, str.capitalize(value))
	      );
	    });
	  },
	          ...
	          React.DOM.tbody(null, 
	            React.DOM.tr(null, 
	              React.DOM.th({scope: "row"}, 
	                React.DOM.label({htmlFor: "style"}, "Style")
	              ), 
	              React.DOM.td(null, 
	            ...
	            React.DOM.tr(null, 
	              React.DOM.th({scope: "row"}, 
	                React.DOM.label({htmlFor: "scrollText"}, "Scroll Text")
	              ), 
	              React.DOM.td(null, 
	                React.DOM.input({name: "scrollText", id: "scrollText", valueLink: this.linkState('scrollText'), className: "regular-text", type: "text"})
	              )
	            ), 
	            React.DOM.tr(null, 
	              React.DOM.th({scope: "row"}, 
	                React.DOM.label({htmlFor: "scrollDistance"}, "Scroll Distance (pixels)")
	              ), 
	              React.DOM.td(null, 
	                React.DOM.input({name: "scrollDistance", id: "scrollDistance", valueLink: this.linkState('scrollDistance'), className: "regular-text", type: "number"})
	              )
	            ), 
	            React.DOM.tr(null, 
	              React.DOM.th({scope: "row"}, 
	                React.DOM.label({htmlFor: "scrollSpeed"}, "Scroll Speed (ms)")
	              ), 
	              React.DOM.td(null, 
	                React.DOM.input({name: "scrollSpeed", id: "scrollSpeed", valueLink: this.linkState('scrollSpeed'), className: "regular-text", type: "number"})
	              )
	            ), 
	            React.DOM.tr(null, 
	              React.DOM.th({scope: "row"}, 
	                React.DOM.label({htmlFor: "animation"}, "Animation")
	              ), 
	              React.DOM.td(null, 
